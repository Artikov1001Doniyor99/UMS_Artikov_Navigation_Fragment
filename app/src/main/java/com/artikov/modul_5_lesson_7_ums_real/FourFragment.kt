...
class FourFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        root.back_xizmatlar.setOnClickListener {
        ...
        root.one_x.setOnClickListener {
            bundle.putString("D","a")
            findNavController().navigate(R.id.xizmatlarFragment,bundle,navOptions.build())
        }

        root.second_x.setOnClickListener {
            bundle.putString("D","b")
            findNavController().navigate(R.id.xizmatlarFragment,bundle,navOptions.build())
        }

        root.third_x.setOnClickListener {
            bundle.putString("D","c")
            findNavController().navigate(R.id.xizmatlarFragment,bundle,navOptions.build())
        }

        root.fourth_x.setOnClickListener {
            bundle.putString("D","d")
            findNavController().navigate(R.id.xizmatlarFragment,bundle,navOptions.build())
        }

        root.fifth_x.setOnClickListener {
