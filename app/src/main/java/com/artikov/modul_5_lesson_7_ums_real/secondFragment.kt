...
class secondFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        root.back_daqiqalar.setOnClickListener {
        ...
        root.one_s.setOnClickListener {
            bundle.putString("D","a")
            findNavController().navigate(R.id.daqiqalarFragment,bundle,navOptions.build())
        }

        root.two_s.setOnClickListener {
            bundle.putString("D","b")
            findNavController().navigate(R.id.daqiqalarFragment,bundle,navOptions.build())
        }

        root.three_s.setOnClickListener {
            bundle.putString("D","c")
            findNavController().navigate(R.id.daqiqalarFragment,bundle,navOptions.build())
        }

        root.four_s.setOnClickListener {
            bundle.putString("D","d")
            findNavController().navigate(R.id.daqiqalarFragment,bundle,navOptions.build())
        }

        root.five_s.setOnClickListener {
