...
class fifthFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        root =  inflater.inflate(R.layout.fragment_fifth, container, false)

        root.back_sms.setOnClickListener {
        ...
        root.one_sms.setOnClickListener {
            bundle.putString("D","a")
            findNavController().navigate(R.id.smsFragment,bundle,navOptions.build())
        }

        root.two_sms.setOnClickListener {
            bundle.putString("D","b")
            findNavController().navigate(R.id.smsFragment,bundle,navOptions.build())
        }

        root.three_sms.setOnClickListener {
            bundle.putString("D","c")
            findNavController().navigate(R.id.smsFragment,bundle,navOptions.build())
        }

        root.four_sms.setOnClickListener {
            bundle.putString("D","d")
            findNavController().navigate(R.id.smsFragment,bundle,navOptions.build())
        }

        root.five_sms.setOnClickListener {
